...
public class MaxAdManager : MonoBehaviour
{
    ...
    //Azeem's changes
    private string MaxID= "l7OzXd9vAtl9dNmuPfwSQWbBuIzm43xyp1cckISv6elBt7nySDaAHH26wfQCn0aTEztaZZC4KTl4fV8F7R2PWQ";
    private string interstitialID= "9ca18f5b0a2e0282";
    private string AppOpenID= "37e575584be38029";
    private string rewardedAdID= "id-should-be-ad";
    private string bannerAdID= "54bbae8270db5b15";
